...
module Maps
{
   ...
   export var titanic = {
    ...
    // x: 2793 y: 1663 ate x: 4657 y: 1663
    export var recta = {
        smallImage: "smallrecta",
        name: "recta",  
        terrainImage: "recta",
        spawnPionts:
            [ 
